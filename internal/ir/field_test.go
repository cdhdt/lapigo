...
func TestField_IsSortEligible_Nullable(t *testing.T) {
	f := &Field{Name: Bare("created_at"), Type: FieldTypeTimestamp, Nullable: true}
...
func TestField_IsSortEligible_Decimal(t *testing.T) {
	f := &Field{Name: Bare("price"), Type: FieldTypeDecimal}
...
func TestField_IsSortEligible_JSON(t *testing.T) {
	f := &Field{Name: Bare("meta"), Type: FieldTypeJSON}
...
func TestField_IsSortEligible_Eligible(t *testing.T) {
	tests := []struct {
		...
		{"non-nullable timestamp", &Field{Name: Bare("created_at"), Type: FieldTypeTimestamp}},
		{"non-nullable uuid pk", &Field{Name: Bare("id"), Type: FieldTypeUUID, PK: true}},
		{"non-nullable string", &Field{Name: Bare("slug"), Type: FieldTypeString}},
	}
